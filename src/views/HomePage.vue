...
<template>
  <div class="p-6 space-y-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow">
      <h2 class="text-lg font-semibold mb-4 text-slate-900">EzIcon 图标组件</h2>
      ...
      <div class="space-y-4">
        <!-- 不同尺寸 -->
        <div>
          <p class="text-sm font-medium text-slate-700 mb-2">不同尺寸：</p>
          <div class="flex gap-4 items-center">
            ...
            <div class="flex flex-col items-center gap-1">
              ...
              <span class="text-xs text-slate-500">20px</span>
            </div>
            <div class="flex flex-col items-center gap-1">
            ...
            <div class="flex flex-col items-center gap-1">
              ...
              <span class="text-xs text-slate-500">48px</span>
            </div>
          </div>
        </div>
        ...
        <!-- 不同颜色 -->
        <div>
          <p class="text-sm font-medium text-slate-700 mb-2">不同颜色：</p>
          <div class="flex gap-4 items-center">
        ...
        <!-- 旋转动画 -->
        <div>
          <p class="text-sm font-medium text-slate-700 mb-2">旋转动画：</p>
          <div class="flex gap-4 items-center">
    ...
    <!-- EzIconPicker 图标选择器 -->
    <div class="bg-white p-6 rounded-lg shadow">
      <h2 class="text-lg font-semibold mb-4 text-slate-900">EzIconPicker 图标选择器</h2>
      <p class="text-slate-600 text-sm mb-4">点击下方输入框，从 88 个精选的 Material Design Icons 中选择图标</p>

      <div class="max-w-md">
        <EzIconPicker v-model="selectedIcon" placeholder="请选择图标" />
      </div>

      <div v-if="selectedIcon" class="mt-4 p-4 bg-slate-50 rounded">
        <p class="text-sm font-medium text-slate-700 mb-2">当前选中图标：</p>
        <div class="flex items-center gap-4">
          <EzIcon :icon="selectedIcon" :size="48" color="var(--ez-primary-light)" />
          <div>
            <code class="text-xs bg-slate-200 px-2 py-1 rounded block">{{ selectedIcon }}</code>
            <p class="text-xs text-slate-500 mt-2">可直接用于菜单配置、表单等场景</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- 技术栈说明 -->
    <div class="bg-white p-6 rounded-lg shadow">
      <h2 class="text-lg font-semibold mb-4 text-slate-900">技术栈</h2>
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="p-4 bg-slate-50 rounded text-center">
          <p class="font-semibold text-slate-900">Vue 3.5+</p>
          <p class="text-xs text-slate-500 mt-1">渐进式框架</p>
        </div>
        <div class="p-4 bg-slate-50 rounded text-center">
          <p class="font-semibold text-slate-900">NaiveUI</p>
          <p class="text-xs text-slate-500 mt-1">组件库</p>
        </div>
        <div class="p-4 bg-slate-50 rounded text-center">
          <p class="font-semibold text-slate-900">Tailwind CSS 4</p>
          <p class="text-xs text-slate-500 mt-1">样式框架</p>
        </div>
        <div class="p-4 bg-slate-50 rounded text-center">
          <p class="font-semibold text-slate-900">Iconify</p>
          <p class="text-xs text-slate-500 mt-1">图标系统</p>
        </div>
      </div>
    </div>
  </div>
